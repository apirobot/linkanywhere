...
APPS_DIR = ROOT_DIR.path('linkanywhere')
...
class Common(Configuration):
    ...
    WSGI_APPLICATION = 'linkanywhere.wsgi.application'

    # Email
    EMAIL_BACKEND = values.Value('django.core.mail.backends.smtp.EmailBackend')

    ADMINS = (
        ('Author', 'denis.orehovsky@gmail.com'),
    )

    # Postgres
    DATABASES = values.DatabaseURLValue('postgres://localhost/linkanywhere')
